...
var _button_texture_default: Texture2D = load(
	"res://addons/phantom_camera/assets/PhantomCameraBtnPrimaryDefault.png"
)
var _button_texture_hover: Texture2D = load(
	"res://addons/phantom_camera/assets/PhantomCameraBtnPrimaryHover.png"
)
...
func show_updater_warning(next_version_number: Array, current_version_number: Array) -> void:
	...
	if (
		next_version_number_0 > current_version_number_0
		or next_version_number_1 > current_version_number_1
	):
